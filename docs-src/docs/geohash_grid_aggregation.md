...
The geohash grid aggregation buckets geo points into geohash grid cells.
...
*   **Precision (int)**  
    _(Required, positional)_ Geohash precision.
...
For more details on the geohash grid aggregation and its parameters, refer to the [official Elasticsearch documentation on geohash grid aggregation](https://www.elastic.co/docs/reference/aggregations/search-aggregations-bucket-geohashgrid-aggregation).
