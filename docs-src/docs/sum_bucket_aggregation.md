...
The sum bucket aggregation computes the sum across buckets of a metric.
...
For more details on the sum bucket aggregation and its parameters, refer to the [official Elasticsearch documentation on sum bucket aggregation](https://www.elastic.co/docs/reference/aggregations/search-aggregations-pipeline-sum-bucket-aggregation).
